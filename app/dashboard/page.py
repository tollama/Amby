...
<body>
      ...
      <div>
        <section>
          ...
          <div class="toolbar">
            ...
            <button class="secondary" id="jsonlBtn">JSONL</button>
  ...
  <script>
    ...
    document.getElementById('jsonlBtn').addEventListener('click', () => { location.href = '/audit/export?format=jsonl&scope=all'; });
